...
## MSDU聚合
  ...
  - ### 结束前1分钟状态
  ```
  [MSDU 聚合(SU 基准)] SU Total: 780431391
  M1:2.1% M2:29.8% M3:20.5% M4:0.0% | 1-4合计: 408738408 (52.37%)
  ```
...
## softnet 统计
  ...
  ```
  CPU   | Packets (Δ)         | Dropped (Δ)         | Squeeze (Δ)         | IRQs (Δ)
  CPU0  | 292928457  (+2954 ) | 0          (+0    ) | 0          (+0    ) | 10         (+0    )
  CPU1  | 293330762  (+2683 ) | 0          (+0    ) | 0          (+0    ) | 29793      (+0    )
  CPU2  | 2091996    (+16   ) | 0          (+0    ) | 0          (+0    ) | 35852      (+0    )
  CPU3  | 807265     (+6    ) | 0          (+0    ) | 0          (+0    ) | 36935      (+0    )
  ```
...
休息10分钟后，又做了一次iperf3 -R电脑端 60秒测试，基本正常，总体速率能接受, 多数在250M+， 最后10次下行速率记录：
```
...
```
去掉-R后，又做了一次上行速率测试，结果在400MB+/s，让明20小时的压测，内核和整体架构的韧性十足！
